...
else
{
    ...
    private void handleLogin() {
        ActionResult<LoginStatus> result = facade.login(txtemail.getText(), txtpassword.getText());
        LoginStatus status = result.getData();
        if (status == null) {
            return;
        }
        switch (status) {
            ...
            case APPROVED_USER:
                ...
                break;
            case PENDING_USER:
                JOptionPane.showMessageDialog(this, result.getMessage(), "Panding", JOptionPane.INFORMATION_MESSAGE);
                focusField(result.getField());
                break;
            case INVALID:
                JOptionPane.showMessageDialog(this, result.getMessage(), "Incorrect", JOptionPane.WARNING_MESSAGE);
                focusField(result.getField());
                break;
            case ERROR:
            default:
