...
//dispose();// TODO add your handling code here:
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
        ActionResult<String> result = facade.findSecurityQuestion(txtemail.getText());
        if (!result.isSuccess()) {
        ...
        txtsq.setText(result.getData());
        txtans.setText("");
        txtpassword.setText("");
    }//GEN-LAST:event_btnsearchActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ActionResult<Void> result = facade.resetPasswordWithEmail(
                txtemail.getText(),
                txtsq.getText(),
                txtans.getText(),
                txtpassword.getText(),
                " Password Field Not Empity",
                "Password Reset\nLogin Now"
        );
        if (!result.isSuccess()) {
            if (result.hasMessage()) {
                if ("Wrong Answer Entery".equals(result.getMessage())) {
                    JOptionPane.showMessageDialog(this, result.getMessage(), "Wrong", JOptionPane.WARNING_MESSAGE);
                    txtpassword.setText("");
                    txtans.setText("");
                } else {
                    JOptionPane.showMessageDialog(this, result.getMessage());
...
if(evt.getKeyCode()==KeyEvent.VK_ENTER){
    ActionResult<Void> result = facade.resetPasswordByAnswerOnly(
            txtemail.getText(),
            txtsq.getText(),
            txtans.getText(),
            txtpassword.getText(),
            "set Password Field Not Empity",
            "Password Reset\nLogin now"
    );
    if (!result.isSuccess()) {
        if (result.hasMessage()) {
