...
public void s(){
    List<Object[]> rows = facade.listAllUsers();
...
s();        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ActionResult<List<Object[]>> result = facade.searchUserByEmail(txtemail.getText());
        if (!result.isSuccess()) {
...
if(evt.getClickCount()==2){
    ...
    if(ck.equalsIgnoreCase("panding")){
        ...
        if(JOptionPane.YES_OPTION==yes){
            facade.updateUserStatus(email, "approved");
            s();
        }
        ...
        if(JOptionPane.YES_OPTION==yes){
            if(JOptionPane.YES_OPTION==yes){
                facade.updateUserStatus(email, "panding");
                s();
            }
        }
    }
