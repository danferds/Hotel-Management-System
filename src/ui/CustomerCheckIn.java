...
if(comboroomnumber.getItemCount()==0)
    ...
    private void comboroomnumberItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboroomnumberItemStateChanged
            updateRoomPriceFromSelection();
    }//GEN-LAST:event_comboroomnumberItemStateChanged

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ActionResult<Void> result = facade.checkInCustomer(
                txtname.getText(),
                txtmob.getText(),
                txtemail.getText(),
                combogender.getItemAt(combogender.getSelectedIndex()),
                txtnat.getText(),
                txtadhar.getText(),
                txtaddres.getText(),
                txtdate.getText(),
                (String) comboroomnumber.getSelectedItem(),
                (String) combobed.getSelectedItem(),
    ...
    private void refreshRoomNumbersAndPrice() {
        List<String> roomNumbers = facade.listAvailableRoomNumbers(
                comboroomtype.getItemAt(comboroomtype.getSelectedIndex()),
                combobed.getItemAt(combobed.getSelectedIndex())
        );
    ...
    private void updateRoomPriceFromSelection() {
        String roomNumber = comboroomnumber.getItemAt(comboroomnumber.getSelectedIndex());
        String price = facade.findRoomPrice(roomNumber);
        if (price != null) {
    ...
    private void focusField(String field) {
        ...
        } else if ("nationality".equals(field)) {
            txtnat.requestFocus();
